...
#include "JSB/jsb_custom_classes.hpp"
...
bool AppDelegate::applicationDidFinishLaunching()
{
    ...
    if(!glview) {
        ...
        glview = cocos2d::GLViewImpl::create("js-sandbox2");
#else
        glview = cocos2d::GLViewImpl::createWithRect("js-sandbox2", Rect(0,0,screenSize.width,screenSize.height));
#endif
    ...
    sc->addRegisterCallback(register_all_custom_classes);
